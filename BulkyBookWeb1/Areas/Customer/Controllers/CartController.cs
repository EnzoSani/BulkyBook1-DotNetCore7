...
namespace BulkyBookWeb1.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            OrderHeader orderHearder = _unitOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == id, includeProperties:"ApplicationUser");
            ...
            _emailSender.SendEmailAsync(orderHearder.ApplicationUser.Email, "New Order - Bulky Book", "<p>New Order Created</p>");
